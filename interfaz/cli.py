...
class CLI:
    ...
    def __init__(self, clinica: Clinica):
        """Inicializa la CLI con una instancia de Clinica."""
    ...
    def _agregar_paciente(self):
        """Agrega un nuevo paciente a la clínica."""
        try:
            nombre = input("Nombre completo: ").strip()
            dni = input("DNI: ").strip()
            fecha_nac = input("Fecha de nacimiento (dd/mm/aaaa): ").strip()
            
            # Crear objeto Paciente con validaciones
    ...
    def _agregar_medico(self):
        """Agrega un nuevo médico a la clínica."""
        try:
            ...
            # Solicitar número de especialidades
            try:
    ...
    def _agendar_turno(self):
        """Agenda un turno para un paciente con un médico."""
        try:
    ...
    def _agregar_especialidad_medico(self):
        ...
        try:
            ...
            # Obtener médico y agregar especialidad
